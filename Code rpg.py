        ...
        while True:
            ...
            if choixConsommable == "1": #Soin
                ...
                if inventaire["(4) Potion de rage"] != 0:
                    ...
                    return f"Vous etes enragé(e) ! Vos attaques infligeront 35% de dégats supplémentaires pendant 5 tours. Vos dégâts : {self.DMG}."
                else:
...
def foret_partie_2_combat_fin():
    ...
    if ChoixHéros=="1":#Salie
        ...
        répliques_foret_p2[1] = "Magnus:"      
        répliques_foret_p2[4] = "Magnus:"  
        répliques_foret_p2[7] = "Magnus:"
        répliques_foret_p2[10] = "Magnus:" 
        répliques_foret_p2[20] = "Magnus:" 
        defilement(répliques_foret_p2)
        input()
...
def montagne():
    ...
    if déplacement == "1":
        ...
        if ChoixHéros=="1":#Affichage du texte pour Salie
            defilement(trame_déplacement_1)
    ...
    if déplacement == "2":
        ...
        if ChoixHéros=="1":#Affichage du texte pour Salie
            defilement(trame_déplacement_2)
...
def Château_abandonné():
    ...
    if ChoixHéros=="1":#Affichage du texte pour Salie
        defilement(trame_combat_dragon)
...
trame_finale_apres_boss()                     #trame de fin après le combat et fin de l'histoir
